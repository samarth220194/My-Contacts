...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="My_Contacts",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11My_Contacts11AppDelegate")
...
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified syncViewHt;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
